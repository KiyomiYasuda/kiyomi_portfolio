      ...
      <form action="../action/actionItem.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="cord-body">
          ...
          <div class="form-row">
            ...
            <div class="col-6"><input type="text" name="up_name" value="<?php echo $item_detail['item_name'] ?>"></div>
          </div>
          <div class="form-row">
            <div class="col-6 py-2">Item Price</div>
            <div class="col-6"><input type="number" name="up_price" value="<?php echo $item_detail['item_price'] ?>"></div>
          </div>
          
          <div class="form-row">
            <div class="col-6 py-2">Item Size</div>
            <div class="col-6"><input type="text" name="up_size" value="<?php echo $item_detail['item_size'] ?>"></div>
          </div>
          <div class="form-row">
            <div class="col-6 py-2">Item Stock</div>            
            <div class="col-6">
              <input type="number" name="up_quantity" value="<?php echo $item_detail['item_quantity'] ?>"></div>
            </div> 
          </div>
